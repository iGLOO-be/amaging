...
describe('Cache Eviction by deleting file', function () {
  it('Should return a 200 OK when retreive cache-eviction-delete.jpg', async () => {
    await request(app)
  ...
  describe('GET: Apply image filter to create cache storage', function () {
    it('Should return a 200 OK by bluring the image', async () => {
      await request(app)
        .get('/test/blur(10,2)&/cache-eviction-delete.jpg')
        .expect(200)
    })

    return it('Should return a 200 OK by resizing the image', async () => {
      await request(app)
  ...
  describe('DELETE the original file (cache-eviction-delete.jpg) to erase the cache', () =>
    it('Should return a 200 OK by erasing the original image', async () => {
      await request(app)
  ...
  return describe('GET: Try to apply other changes to the file just erased', () =>
    it('Should return a 404 not found because the image has been deleted', async () => {
      await request(app)
...
describe('Cache Eviction by updating file', function () {
  describe('POST an image', () =>
    it('Should return a 200 OK when adding an image (cache-eviction-update.jpg)', async () => {
  ...
  describe('GET: Apply image filter to create cache storage', () =>
    it('Should return a 200 OK by changing the igloo', async () => {
      await request(app)
  ...
  describe('UPDATE the original file (cache-eviction-update.jpg by tipi.jpg) to erase the cache', () =>
    it('Should return a 200 OK by updating the original image', async () => {
  ...
  return describe('GET: Apply image filter on the tipi and compare hash with the former igloo cached file', () =>
    it('Should return the right hash of the image to check if the cache has been erased', async () => {
